...
const updateTaxRates = (id, name, description, tax_category_id, rate) => {
  try {
    if (id) {
      let results = tax_rates.update({
        name: name,
...
module.exports = { createTaxRates, getTaxRates, getTaxRatesById, deleteTaxById,updateTaxRates }